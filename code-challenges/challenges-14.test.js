...
Write a function named toTitleCase that takes in an array of strings and returns
...
let biggerThanLuke = (arr) => {
  let bigBoned = arr.filter(person => person.mass > 77 )
  let person = bigBoned.map(e => e.name).join(' - ')
  return person
};
