...
const sortNumbersByLength = (arr) => {
  ...
  for (let i = 0; i< arr.length; i++){
    ...
    newArray.push(stringifiedNumber);
  }
  arr = newArray;
  arr.sort(function(a,b){
    return a.length - b.length;
  ...
  for(let i =0; i<arr.length ;i++){
    let newNum = arr[i];
    let toIntNum = parseFloat(newNum);
    numArray.push(toIntNum);
  }
  return numArray;
}
...
// const people = [
// 	{firstName:'Wes',lastName:'Washington', age: 25},
// 	{firstName:'Casey',lastName:'Codefellow', age: 38},
// 	{firstName:'Stan',lastName:'Seattle', age: 67}
// ]
